...
Then rescale to 20% by multiplying by 5.
...
Since flood is already on scale from 0 to 4, simply multiply by 3.333 to achieve the 20% weight.

```{r mask-and-rescale-flood}
flood_r <- flw * mask * 3.333
